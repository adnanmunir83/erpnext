...
frappe.ui.form.on(cur_frm.doctype, {
	...
	refresh: function(frm) {
		if (frm.doc.docstatus == 0 && in_list(["Quotation", "Sales Order", "Sales Invoice", "Delivery Note", "Purchase Order","Purchase Receipt","Purchase Invoice" ,"Stock Entry","Stock Reconciliation", "Material Request"], frm.doctype)) {
