...
$(document).bind('toolbar_setup', function() {
	...
	frappe.help_feedback_link = '<p><a class="text-muted" \
		href="http://www.resourcefactors.com">Feedback</a></p>'


	$('.navbar-home').html('<img class="erpnext-icon" src="'+
			frappe.urllib.get_base_url()+'/assets/erpnext/images/erp-icon.svg" />');

	$('[data-link="docs"]').attr("href", "http://www.resourcefactors.com")
	$('[data-link="issues"]').attr("href", "http://www.resourcefactors.com")
	...
	$('<li><a data-link-type="forum" href="http://www.resourcefactors.com" \
		target="_blank">'+__('User Forum')+'</a></li>').insertBefore($help_menu);
	$('<li><a href="http://www.resourcefactors.com" \
