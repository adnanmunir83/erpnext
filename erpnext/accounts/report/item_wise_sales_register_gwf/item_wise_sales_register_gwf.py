...
def _execute(filters=None, additional_table_columns=None, additional_query_columns=None):
	...
	for d in item_list:
		...
		row = [d.posting_date,d.parent,d.customer, d.item_code, d.item_group,  ]
		...
		row += [
			...
			delivery_note, d.income_account, d.cost_center
		]
...
def get_columns(additional_table_columns):
	columns = [
		_("Posting Date") + ":Date:80", _("Invoice") + ":Link/Sales Invoice:120",
		_("Customer") + ":Link/Customer:120", _("Item Code") + ":Link/Item:120",
	...
	columns += [
		_("Stock Qty") + ":Float:80", _("Stock UOM") + "::80",
		_("Rate") + ":Currency/currency:80",
