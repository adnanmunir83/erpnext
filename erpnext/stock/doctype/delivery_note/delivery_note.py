...
class DeliveryNote(SellingController):
	...
	def custom_validate_payment(self):
		...
		if sales_order_list:
			order_details = frappe.db.get_value("Sales Order", sales_order_list[0], ["advance_paid", "rounded_total", "allow_delivery"], as_dict=1)
			if order_details and not order_details.allow_delivery and (order_details.advance_paid < self.rounded_total):
